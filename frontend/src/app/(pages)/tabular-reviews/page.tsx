...
// t() wolane on-render zeby slownik byl zaladowany (patrz iter3 reguly).
function tabs(): { id: Tab; label: string }[] {
    return [
        { id: "all", label: t("tabular.tabAll") },
        { id: "in-project", label: t("tabular.tabInProject") },
        { id: "standalone", label: t("tabular.tabStandalone") },
    ];
}
...
export default function TabularReviewsPage() {
    ...
    const projectFilterButton = (
        <div className="relative" ref={filterRef}>
            ...
            >
                {selectedProject ? selectedProject.name : t("tabular.filterByProject")}
        ...
        <div className="flex-1 overflow-y-auto bg-white">
            ...
            <div className="mb-1 flex items-center justify-between px-4 py-3 md:px-10">
                ...
                <div className="flex items-center gap-2">
                    <HeaderSearchBtn value={search} onChange={setSearch} placeholder={t("tabular.searchPlaceholder")} />
                    <button
                                        ...
                                        <RowActions
                                            ...
                                            onDelete={async () => {
                                                if (
                                                    ...
                                                    setOwnerOnlyAction(
                                                        t("ownerOnly.actionDeleteReview"),
                                                    );
                                                    return;
                                                }
