        ...
        <div className="fixed inset-0 z-[101] flex items-center justify-center bg-black/20 backdrop-blur-xs">
            <div className="w-full max-w-2xl rounded-2xl bg-white shadow-2xl flex flex-col h-[600px]">
                ...
                <div className="px-6 pt-3 pb-5 flex flex-col gap-4 overflow-y-auto flex-1">
                    <div>
                        <p className="text-sm font-medium text-gray-500 mb-2">{t("workflowColumn.title")}</p>
                    ...
                    {col.tags && col.tags.length > 0 && (
                        <div>
                            <p className="text-sm font-medium text-gray-500 mb-2.5">{t("workflowColumn.tags")}</p>
