...
import { createWorkflow, updateWorkflow } from "@/app/lib/patronApi";
...
interface Props {
    open: boolean;
    onClose: () => void;
    onCreated: (workflow: PATRONWorkflow) => void;
    editWorkflow?: PATRONWorkflow;
    onUpdated?: (workflow: PATRONWorkflow) => void;
}
