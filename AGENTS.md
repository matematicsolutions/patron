...
Tests: 1265/1270 pass (5 todo, 0 fail) as of 2026-06-14. TSC clean (backend + frontend). **Do not commit if tests fail** - quality gate from the [Constitution](./governance/CONSTITUTION.md) Art. 7.
