...
## Confidentiality is part of conduct here

Patron is built for law firms, and this project is bound by the professional
secrecy that its users are bound by. Do not post client data, case files, real
case signatures, personal data, or any material covered by legal professional
privilege in issues, pull requests, discussions, or commit messages - not even
redacted, not even "just to reproduce the bug". Use synthetic examples. A
maintainer who spots such material will remove it, and may close the thread
without further discussion.

If a bug can only be shown with real material, do not open a public issue.
Write to **security@matematic.co** and we will arrange a private channel.
...
reported to the maintainers at **kontakt@matematic.co**. All complaints will be
...
1. **Correction** - a private, written warning, with clarity about the nature of
   the violation and why the behaviour was inappropriate.
