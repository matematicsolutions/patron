...
### #8 - "Zweryfikuj cytaty" jako akcja [PLANOWANE w tej galezi]
Wyeksponowanie istniejacej biblioteki `lib/citation` jako akcji na gotowym tekscie. Patrz kolejny krok.
