-- Migration 017: rozszerzenie whitelist event_type o mutation.approval.decision.
-- ADR-0137 (governance/adr/0137-mutation-approval-cards-human-in-the-loop.md).
-- Format UP/DOWN per ADR-0038.
--
-- Nowa wartosc (do listy z migracji 015):
...
-- DOWN
-- Idempotent rollback - przywracamy whitelist z migracji 015 (19 wartosci).
