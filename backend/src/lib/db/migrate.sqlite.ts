...
/**
 * Krok v5 (ADR-0137): tabela mutation_approvals (fallback dla istniejacych baz)
 * + nowy event_type w CHECK audit_log. Oba w jednej transakcji (runner).
 */
function migrateV5MutationApprovals(db: Database.Database): void {
